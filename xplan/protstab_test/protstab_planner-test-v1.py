...
plan_path = os.path.join(path_stub, 'draft_protstab_plan.json')
...
aq_plan_name = "ProtStab Test Plan"
...
for step_id in plan.step_ids():
    ...
    if plan_step.operator_type == 'protstab_round_1':
        ...
        for txn in plan_step.transformations:
            src = txn['source']
